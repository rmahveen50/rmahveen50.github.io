...
I built automated data preprocessing pipelines using Python, Pandas, and NumPy, and trained classification models using scikit-learn and XGBoost. To address class imbalance common in clinical datasets, I applied SMOTE-based sampling strategies, which improved minority class recall and overall model robustness. The work emphasized careful feature preparation, evaluation metrics relevant to healthcare outcomes, and reproducibility of experiments.
